/**
 * 1.use form tag and onSubmit handler with event (e) From e access e.target.[name of the input filed].value 
 * 
 ...
 * 
 * 4.uncontrolled element: useRef to create a reference to the element and access  value by using like:name.curent.value
 * 
